...
<?
	...
	$struct = new Structure(_DIR_STRUCTURES_PATH . "news_system.xml");
	...
	if ($function == "delete.start") {
		...
		//$browse->addButton($PHP_SELF."?function=down&id=%id%&offset=".$session->getParameter("offset"), "dó³", 10,"_down.gif");

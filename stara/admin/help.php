...
<?
	...
	$struct = new Structure(_DIR_STRUCTURES_PATH . "cms_help.xml");
	...
	if ($function == "delete.start") {
		...
		$browse->addButton($PHP_SELF."?function=up&id=%id%", $session->lang->systemText["ICON_UP"], 10,"_up.gif");
    	$browse->addButton($PHP_SELF."?function=down&id=%id%", $session->lang->systemText["ICON_DOWN"], 10,"_down.gif");

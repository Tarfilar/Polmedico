...
if ($lang=='en') {
	...
	$ohtml .= include('inc/php/content_en_gwarancja_ceny.php');
	...
	$ohtml .= include('inc/php/top_of_menu.php');
	$ohtml .= include('inc/php/menu.php');
	$ohtml .= include('inc/php/content_de_gwarancja_ceny.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################
	...
	$ohtml .= include('inc/php/menu_lang.php');
	$ohtml .= include('inc/php/menu.php');
	$ohtml .= include('inc/php/content_pl_gwarancja_ceny.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################

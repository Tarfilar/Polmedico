...
if ($lang=='en') {
	...
	$ohtml .= include('inc/php/menu_en.php');
	$ohtml .= include('inc/php/content_en.php');
	...
	$ohtml .= include('inc/php/top_of_menu.php');
	$ohtml .= include('inc/php/menu_de.php');
	$ohtml .= include('inc/php/content_de.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################
	...
	$ohtml .= include('inc/php/content_pl.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################

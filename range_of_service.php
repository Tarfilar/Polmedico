...
if ($lang=='en') {
	...
	$ohtml .= include('inc/php/content_en_range_of_service.php');
	...
	$ohtml .= include('inc/php/top_of_menu.php');
	$ohtml .= include('inc/php/menu.php');
	$ohtml .= include('inc/php/content_de_range_of_service.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################
	...
	$ohtml .= include('inc/php/menu_lang.php');
	$ohtml .= include('inc/php/menu.php');
	$ohtml .= include('inc/php/content_pl_range_of_service.php');
	$ohtml .= "<div id=\"site_main\">";
	//#############################
